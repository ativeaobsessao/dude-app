      ...
      <div className="flex items-center gap-4 text-right shrink-0 ml-4">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="p-2 text-[#6a7570]/50 hover:text-primary-green hover:bg-[#6a7570]/10 rounded-lg transition-all lg:opacity-0 lg:group-hover:opacity-100 duration-150 cursor-pointer"
            title="Editar Sessão"
          >
            <Edit2 size={16} />
          </button>
