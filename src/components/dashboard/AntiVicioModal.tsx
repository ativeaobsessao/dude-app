    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg bg-[#0d0d0d] border border-white/10 rounded-[32px] shadow-2xl p-6 md:p-8 overflow-hidden select-none"
        >
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2.5">
              ...
              <div className="text-left font-sans">
                <h3 className="text-xl font-bold text-text-primary tracking-tight">S.O.S. Autocontrole</h3>
                <span className="text-[9px] font-mono font-bold uppercase tracking-[0.2em] text-red-500/75 block">Blindagem Psicológica</span>
              </div>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="space-y-6 font-sans">
              ...
              <div className="space-y-1.5 text-left">
                ...
                {avoidHabits.length > 0 ? (
                  <select
                    ...
                    className="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-3.5 px-4 text-sm text-text-primary focus:outline-none focus:border-[#6ee7a8]/40 font-bold transition-all"
                  >
                    ...
                    <button
                      ...
                      className={`text-xs px-3 py-2 rounded-xl border font-bold transition-all cursor-pointer ${
                        selectedTag === tag.value
                          ...
                          : 'bg-white/5 border-white/10 text-text-secondary/70 hover:border-white/20'
                      }`}
                    >
                      {tag.label}
                    </button>
              ...
              <div className="space-y-1.5 text-left">
                ...
                <textarea
                  ...
                  placeholder="O que está sentindo ou pensando agora? Escrever ajuda a desarmar o mecanismo de recompensa automática..."
                  className="w-full min-h-[72px] bg-white/[0.03] border border-white/10 hover:border-white/15 focus:border-[#6ee7a8]/40 rounded-2xl py-3 px-4 text-xs md:text-sm text-text-primary focus:outline-none transition-all resize-none placeholder-text-secondary/40"
                />
              </div>
